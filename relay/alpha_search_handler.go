...
func AlphaSearchHelper(c *gin.Context, info *relaycommon.RelayInfo) (gatewayError *types.AIGatewayError) {
	...
	if httpResp.StatusCode < 200 || httpResp.StatusCode >= 300 {
		gatewayError = service.RelayErrorHandler(c.Request.Context(), httpResp, false)
		service.ResetStatusCode(gatewayError, statusCodeMappingStr)
		return gatewayError
	}
