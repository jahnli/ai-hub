...
export function ImageStudio() {
  ...
  return (
    <div className='flex size-full min-h-0 flex-col gap-4 p-4 lg:grid lg:grid-cols-[280px_minmax(0,1fr)_300px] lg:gap-0 lg:p-0'>
      {/* Params panel */}
      <ScrollArea className='min-h-0 rounded-lg border p-3 lg:rounded-none lg:border-0 lg:border-r lg:p-4'>
        <ParamsPanel
          config={config}
      ...
      {/* History */}
      <div className='min-h-64 rounded-lg border p-3 lg:min-h-0 lg:rounded-none lg:border-0 lg:border-l lg:p-4'>
        <HistoryPanel
          history={history}
