...
DEV_BACKEND_SERVICE = ai-gateway
DEV_POSTGRES_DB = ai-gateway
DEV_POSTGRES_USER = root
DEV_SQLITE_PATH ?= one-api.db

.PHONY: all build-web build-all-web start-backend dev dev-api dev-api-rebuild dev-web reset-setup test
