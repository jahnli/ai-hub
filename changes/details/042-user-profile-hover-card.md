...
- `web/default/src/features/users/components/user-profile-hover-card.tsx` — 新增飞书风格用户资料悬浮卡片组件（Banner 背景图 + 大头像 + 姓名角色 + 字段列表），解析 custom_field_values JSON 提取职级/职位描述/出生日期/民族/探亲地
