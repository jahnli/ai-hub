...
- `web/default/src/i18n/locales/*.json` — 新增 Model Usage Trend、Avg Price Trend、Registered/Total、Total Requests、Average price per million tokens、Average response time、Request error rate、Registered/Unregistered user count 等翻译（6 语言）
