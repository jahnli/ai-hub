...
- `web/default/src/i18n/locales/zh.json` — 新增 Trans 组件 key、`AI Engineering Efficiency`、`Li Jiaheng`、`Having issues? Chat on Feishu` 的中文翻译；`API Base URL` 中文翻译改为保留英文术语（不再译为「API 基础地址」）
