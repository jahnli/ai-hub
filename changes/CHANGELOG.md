...
| 042 | 2026-06-25 | 用户管理表格头像悬停资料卡片：飞书风格（背景图 Banner + 大头像 + 姓名角色），展示职务、职级、工号、手机、邮箱、部门、职位描述、入职日期、出生日期、民族、探亲地等字段；支持 custom_field_values 解析；6 语言翻译 | [详情](details/042-user-profile-hover-card.md) |
