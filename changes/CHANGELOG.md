...
| 058 | 2026-07-03 | 新增在线生图功能：支持图片生成/编辑、参数配置、提示词预设、历史记录和 Playground 图片中继接口；补充 gpt-image-2 参数适配、生成进度/停止按钮与结果参数翻译优化，侧边栏入口及 6 语言文案调整为“在线生图” | [详情](details/058-online-image-generation.md) |
