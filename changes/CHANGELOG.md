...
| 064 | 2026-07-07 | 分组模型设置优化：分组倍率与特殊可用模型编辑器增强可见性规则和 JSON 解析 | [详情](details/064-group-ratio-editor.md) |
| 065 | 2026-07-07 | 新增 SSRF 防护：统一保护外部下载、视频代理、Webhook、用户通知和 Midjourney 代理等 HTTP 请求 | [详情](details/065-ssrf-protection.md) |
