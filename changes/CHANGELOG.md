...
| 043 | 2026-07-22 | 数据总览页增强：完善部门统计、使用分析、用户排行、日志、导出和权限裁剪；新增公司配置管理以及飞书、钉钉、无平台多公司数据总览，按公司隔离组织树、成员缓存和统计权限；钉钉成员列表按应用限制为 30 QPS，遇到 90018 限流时有限退避重试并脱敏错误 | [详情](details/043-data-overview.md) |
