...
| 057 | 2026-07-02 | 数据看板筛选优化：顶部前置时间范围、时间粒度、超级管理员用户名称筛选和搜索/重置按钮，模型分析与 Flow 共用筛选条件，用户名筛选支持匹配 display_name，筛选区与模块 Tab 位置互换并微调时间选择器宽度，移除模型偏好设置按钮并清理相关翻译 | [详情](details/057-dashboard-filters.md) |
