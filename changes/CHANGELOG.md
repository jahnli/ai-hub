...
| 055 | 2026-07-08 | 模型广场优化：「动态计费」标签颜色从橙色改为主题色，超级管理员可查看全部分组；StatusBadge 新增 primary variant | `web/default/src/features/pricing/components/model-card.tsx`、`web/default/src/components/status-badge.tsx`、`controller/pricing.go` |
